...
用法：
    # 单文件
    exam-review knowledge-base/mock-exams/physics/beijing/2026-chaoyang-yi.yaml
...
DEFAULT_EXAMS_ROOT = REPO_ROOT / "knowledge-base" / "mock-exams"
...
def main():
    ...
    group.add_argument("--subject", "-s",
                       help="科目目录名（如 physics）；扫描 knowledge-base/mock-exams/<subject>/")
